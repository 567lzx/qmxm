...
<a href="/res?n=1" class="a2 a">首页</a>
<a href="/res?n=<%=pageNow-1%>" class="a2 a">上一页</a>
<a href="/res?n=<%=pageNow+1%>" class="a2 a" >下一页</a>
<a href="/res?n=<%=pageCount%>" class="a2 a">尾页</a>

    跳转到第<select onchange="location.href='/res?n='+this.value" class="a2">
