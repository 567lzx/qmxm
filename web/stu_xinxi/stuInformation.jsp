...
<body style="width:80%; height:89%">
    ...
    <div>
    <label>
        <input id="shuru" onkeydown="search1()" type="text" placeholder="请输入学生姓名"><i onclick="search2()" class="fa fa-search box"></i>
    </label>
    </div>
<script>
    function search1(){
...
<table border="0" style="text-align:center;">
    ...
    <tr>
        ...
        <td><a class="a2 a" href="/stu_xinxi/stuModify.jsp?stuId=<%=studentList.getId()%>&stuName=<%=studentList.getName()%>&stuCla=<%=studentList.getCla()%>&stuSex=<%=studentList.getSex()%>&stuTele=<%=studentList.getTele()%>" >修改</a>|<a class="a2 a" href="${pageContext.request.contextPath}/stuDelete?stuId=<%=studentList.getId()%>" >删除</a></td>
    </tr>
...
<a href="/stu?n=1" class="a2 a">首页</a>
<a href="/stu?n=<%=pageNow-1%>"class="a2 a">上一页</a>
<a href="/stu?n=<%=pageNow+1%>" class="a2 a" >下一页</a>
<a href="/stu?n=<%=pageCount%>" class="a2 a">尾页</a>

    跳转到第<select onchange="location.href='/stu?n='+this.value" class="a2">
