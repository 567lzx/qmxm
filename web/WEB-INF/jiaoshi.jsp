...
<div class="div2">当前用户&nbsp;&nbsp;教师：${sessionScope.teaName} &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a class="zx a1" href="${pageContext.request.contextPath}/logout">注销登录</a></div>
<div class="div3">
    ...
    <a href="${pageContext.request.contextPath}/stu" target="stu" class="menu fa fa-graduation-cap" aria-hidden="true" style=" color:#fcfffc; font-size:18px; display: block;text-decoration: none;height: 40px;padding-left: 40px;padding-top: 25px;">学生信息</a>
</div>
