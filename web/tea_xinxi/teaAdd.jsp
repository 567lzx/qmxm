...
<div class="div1">添加教师信息</div>
<form action="/teaAdd">
<div class="div2">教师姓名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="teaName" ><br></div>
        <div class="div2">教师性别&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="teaSex" ><br></div>
            <div class="div2">教师电话&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="teaTele" ><br></div>
