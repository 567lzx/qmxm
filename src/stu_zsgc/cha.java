...
public class cha extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SElECT COUNT(*) FROM stu WHERE stu_id LIKE ?";
            ...
            dataSource = DruidDataSourceFactory.createDataSource(prop);
            conn = dataSource.getConnection();
            String sql1 = "SElECT stu_id,stu_name,stu_class,stu_sex,stu_tele FROM stu WHERE stu_id LIKE ? limit ?,?";
...
//            获取数据getXXX（）
                ...
                String cla = rs.getString("stu_class");
                String sex= rs.getString("stu_sex");
                int tele= rs.getInt("stu_tele");
...
//            System.out.println(list1.get(0));
            ...
            req.getRequestDispatcher("/stu_xinxi/stuQuery.jsp").forward(req, resp);
...
public class cha extends HttpServlet {
    ...
    /*Servlet通过一个POST请求接收表单数据，包括学生姓名、班别、性别、电话、id。*/
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (var mongoClient = MongoClients.create("mongodb://localhost:27017")) {
            ...
            /*根据学生姓名使用正则表达式构造一个查询过滤器，并使用该过滤器查询符合条件的文档数量。*/
            ...
            //Document doc = new Document("stu_name", new Document("$regex", "/" + stuName + "/"));
            // 查询符合条件的文档并进行分页
            ...
            while (cursor.hasNext()) {
                ...
                int id = document.getInteger("stu_id");
                String name = document.getString("stu_name");
                String cla = document.getString("stu_class");
                String sex= document.getString("stu_sex");
                int tele= document.getInteger("stu_tele");
                // 赋值
                account.setId(id);
                account.setName(name);
                account.setCla(cla);
